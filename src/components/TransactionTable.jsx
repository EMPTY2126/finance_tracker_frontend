          ...
          {transactions.map((t) => (
            <tr key={t.id} className="border-b border-border last:border-0">
              ...
              <td className="py-3 pr-4 text-right">
                <button onClick={() => onEdit(t)} className="mr-3 text-xs font-medium text-muted hover:text-brand">
                  Edit
                </button>
                <button onClick={() => onDelete(t)} className="text-xs font-medium text-muted hover:text-rose">
                  Delete
                </button>
              </td>
            </tr>
